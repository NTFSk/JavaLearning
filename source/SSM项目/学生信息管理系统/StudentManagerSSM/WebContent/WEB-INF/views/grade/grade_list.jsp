	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果该年级下存在班级信息则无法进行删除，须先删除年纪下属的班级信息", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><input id="edit_remark" style="width: 256px; height: 180px;" class="easyui-textbox" type="text" name="remark" data-options="required:true, missingMessage:'请填写备注'"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
